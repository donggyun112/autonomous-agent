...
export type LoginCallbacks = {
  // Called with the browser URL the user should visit.
  onAuthUrl: (url: string) => void;
  // Called to prompt the user to paste the authorization code back.
  onPromptCode: () => Promise<string>;
};

// Begin the login flow. Returns the credentials on success.
export async function loginAnthropic(callbacks: LoginCallbacks): Promise<OAuthCredentials> {
